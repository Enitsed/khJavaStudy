...
public class Prob002_binding {
	public static void main(String[] args) {
		...
		/* Engineer는 급여의 13%, Developer는 15%를 특별보너스로 지급하는 프로그램을 구현하세요. */
		...
		for (Employee o : em) {
			System.out.println(o.toString() + getSpecialBonus(o));
		}

	}

	public static int getSpecialBonus(Employee o) {

		if (o instanceof Engineer) {
			return o.salary * 13 / 100;
		} else if (o instanceof Developer) {
			return o.salary * 15 / 100;
		}
