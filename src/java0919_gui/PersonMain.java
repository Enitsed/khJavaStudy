...
public class PersonMain extends JPanel {
	...
	/*
	 * public static void main(String[] args) { PersonMain pm = new PersonMain();
	 * JFrame frame = new JFrame(); frame.add(BorderLayout.CENTER, pm);
	 * frame.setSize(520, 550); frame.setVisible(true);
