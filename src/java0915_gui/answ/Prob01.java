...
class MenuItem extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == firstCom) {
			...
			secondCom.setModel(new DefaultComboBoxModel<String>(foodSub[index - 1]));
			/*
			 * for(int i=secondCom.getItemCount()-1 ;i>=0; i--) secondCom.removeItemAt(i);
			...
			ta.setText(firstCom.getSelectedItem() + " : " + secondCom.getSelectedItem());
		}
	}
